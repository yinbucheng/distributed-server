...
public class Config {
    ...
    CuratorFramework curatorFramework() {
        ...
        int sessionTimeOut = EnvironmentUtils.getIntValue("mst.zk.session.timeout", 3000);
        int connectionTimeOut = EnvironmentUtils.getIntValue("mst.zk.connection.timeout", 10000);
        int baseSleepTimeMS = EnvironmentUtils.getIntValue("mst.zk.sleep.time", 10000);
